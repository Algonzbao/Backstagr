...
import { Comment, CommentSchema } from 'src/schemas/comments.schema'; // Import your Comment schema
import { CommentsService } from './comments.service'; // Create a CommentsService
